...
<style>
	...
	button {
		...
		background: none;
		padding: 0;
		transition: color 100ms 0ms cubic-bezier(0.4, 0, 0.2, 1), background-color 100ms 0ms cubic-bezier(0.4, 0, 0.2, 1);
	}
	i {
		line-height: normal;
		position: absolute;
	...
	#app {
		font-family: 'Montserrat', 'RobotoMono', Arial, sans-serif;
